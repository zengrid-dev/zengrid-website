...
- Add [sorting](/examples/sortable) to enable column sorting
- Add [filtering](/examples/filterable) to filter data
- Enable [editing](/examples/editable) for inline data editing
- Scale to [millions of rows](/examples/million-rows) with virtual scrolling
