...
5. **Save**: the active edit is committed and the value is written back
...
Use built-in editors by name, or pass a custom `CellEditor` instance directly on the column.
